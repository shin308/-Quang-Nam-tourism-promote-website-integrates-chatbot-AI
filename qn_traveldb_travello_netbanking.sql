...
DROP TABLE IF EXISTS `travello_netbanking`;
...
LOCK TABLES `travello_netbanking` WRITE;
/*!40000 ALTER TABLE `travello_netbanking` DISABLE KEYS */;
/*!40000 ALTER TABLE `travello_netbanking` ENABLE KEYS */;
UNLOCK TABLES;
