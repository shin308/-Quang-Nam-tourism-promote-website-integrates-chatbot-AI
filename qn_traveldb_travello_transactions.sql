...
DROP TABLE IF EXISTS `travello_transactions`;
...
LOCK TABLES `travello_transactions` WRITE;
/*!40000 ALTER TABLE `travello_transactions` DISABLE KEYS */;
/*!40000 ALTER TABLE `travello_transactions` ENABLE KEYS */;
UNLOCK TABLES;
