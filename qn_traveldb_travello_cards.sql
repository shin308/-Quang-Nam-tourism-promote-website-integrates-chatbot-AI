...
DROP TABLE IF EXISTS `travello_cards`;
...
LOCK TABLES `travello_cards` WRITE;
/*!40000 ALTER TABLE `travello_cards` DISABLE KEYS */;
/*!40000 ALTER TABLE `travello_cards` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-11-01 22:37:11
